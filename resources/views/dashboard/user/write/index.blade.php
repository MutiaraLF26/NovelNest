...
@section('container')
    <div class="text-center">
        <button class="mt-6 flex items-center text-white bg-yellow-900 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-yellow-300 dark:hover:bg-yellow-900 focus:outline-none dark:focus:ring-yellow-500" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation">
    ...
    <div class="py-8 px-6 mx-auto max-w-screen-2xl lg:py-16">
        ...
        <form action="{{ route('writeNovelStore') }}" method="POST" enctype="multipart/form-data">
            @csrf
